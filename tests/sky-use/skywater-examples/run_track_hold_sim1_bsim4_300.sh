...
LOG="${LOG:-${SCRIPT_DIR}/artifacts/logs/run_track_hold_sim1_bsim4_300.log}"
RAW="${RAW:-${SCRIPT_DIR}/artifacts/raw/track_hold_sim1_bsim4_300.raw}"
WRDATA="${WRDATA:-${SCRIPT_DIR}/artifacts/wrdata/track_hold_sim1_bsim4_300_out.txt}"
