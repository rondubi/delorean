...
LOG="${LOG:-${SCRIPT_DIR}/artifacts/logs/run_track_hold_sim2_bsim4_300_perf.log}"
RAW="${RAW:-${SCRIPT_DIR}/artifacts/raw/track_hold_sim2_bsim4_300_perf.raw}"
WRDATA="${WRDATA:-${SCRIPT_DIR}/artifacts/wrdata/track_hold_sim2_bsim4_300_perf_out.txt}"
...
PERF_LOG="${PERF_LOG:-${SCRIPT_DIR}/artifacts/perf/run_track_hold_sim2_bsim4_300_perf_${RUN_ID}.csv}"
STRACE_LOG="${STRACE_LOG:-${SCRIPT_DIR}/artifacts/strace/run_track_hold_sim2_bsim4_300_strace_${RUN_ID}.log}"
