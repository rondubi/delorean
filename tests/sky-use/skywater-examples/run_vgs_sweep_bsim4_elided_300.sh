...
LOG="${LOG:-${SCRIPT_DIR}/artifacts/logs/run_vgs_sweep_bsim4_elided_300.log}"
RAW="${RAW:-${SCRIPT_DIR}/artifacts/raw/vgs_sweep_bsim4_elided_300.raw}"
WRDATA="${WRDATA:-${SCRIPT_DIR}/artifacts/wrdata/vgs_sweep_bsim4_elided_300_out.txt}"
...
save all
op
dc vsgp {vgs_start} {vgs_stop} {vgs_step}
wrdata ${WRDATA} \
