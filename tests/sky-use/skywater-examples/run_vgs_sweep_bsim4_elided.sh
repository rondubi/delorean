...
LOG="${LOG:-${SCRIPT_DIR}/artifacts/logs/run_vgs_sweep_bsim4_elided.log}"
RAW="${RAW:-${SCRIPT_DIR}/artifacts/raw/vgs_sweep_bsim4_elided.raw}"
WRDATA="${WRDATA:-${SCRIPT_DIR}/artifacts/wrdata/vgs_sweep_bsim4_elided_out.txt}"
