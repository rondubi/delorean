...
LOG="${LOG:-${REPO_ROOT}/artifacts/logs/run_vgs_sweep_bsim4_elided_300_perf.log}"
RAW="${RAW:-${REPO_ROOT}/artifacts/raw/run_vgs_sweep_bsim4_elided_300_perf.raw}"
WRDATA="${WRDATA:-${REPO_ROOT}/artifacts/wrdata/run_vgs_sweep_bsim4_elided_300_perf_out.txt}"
...
PERF_LOG="${PERF_LOG:-${REPO_ROOT}/artifacts/perf/run_vgs_sweep_bsim4_elided_300_perf_${RUN_ID}.csv}"
STRACE_LOG="${STRACE_LOG:-${REPO_ROOT}/artifacts/strace/run_vgs_sweep_bsim4_elided_300_strace_${RUN_ID}.log}"
