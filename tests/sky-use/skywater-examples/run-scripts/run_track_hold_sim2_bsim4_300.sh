...
LOG="${LOG:-${REPO_ROOT}/artifacts/logs/run_track_hold_sim2_bsim4_300.log}"
RAW="${RAW:-${REPO_ROOT}/artifacts/raw/track_hold_sim2_bsim4_300.raw}"
WRDATA="${WRDATA:-${REPO_ROOT}/artifacts/wrdata/track_hold_sim2_bsim4_300_out.txt}"
