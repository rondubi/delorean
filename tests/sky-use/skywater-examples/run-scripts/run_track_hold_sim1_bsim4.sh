...
LOG="${LOG:-${REPO_ROOT}/artifacts/logs/run_track_hold_sim1_bsim4.log}"
RAW="${RAW:-${REPO_ROOT}/artifacts/raw/track_hold_sim1_bsim4.raw}"
WRDATA="${WRDATA:-${REPO_ROOT}/artifacts/wrdata/track_hold_sim1_bsim4_out.txt}"
