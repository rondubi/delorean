...
NETLIST="${NETLIST:-${REPO_ROOT}/netlists/track_hold_sim1.spice}"
LOG="${LOG:-${REPO_ROOT}/artifacts/logs/run_track_hold_sim1_bsim4_elided.log}"
RAW="${RAW:-${REPO_ROOT}/artifacts/raw/track_hold_sim1_bsim4_elided.raw}"
WRDATA="${WRDATA:-${REPO_ROOT}/artifacts/wrdata/track_hold_sim1_bsim4_elided_out.txt}"
