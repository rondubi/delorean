...
LOG="${LOG:-${REPO_ROOT}/artifacts/logs/run_vgs_sweep_bsim4.log}"
RAW="${RAW:-${REPO_ROOT}/artifacts/raw/vgs_sweep_bsim4.raw}"
WRDATA="${WRDATA:-${REPO_ROOT}/artifacts/wrdata/vgs_sweep_bsim4_out.txt}"
