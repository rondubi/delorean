...
# Runs the track-and-hold sim1 deck with the elided BSIM4 OSDI plugin, with perf + strace.
...
LOG="${LOG:-${SCRIPT_DIR}/artifacts/logs/run_track_hold_sim1_bsim4_elided_300_perf.log}"
RAW="${RAW:-${SCRIPT_DIR}/artifacts/raw/track_hold_sim1_bsim4_elided_300_perf.raw}"
WRDATA="${WRDATA:-${SCRIPT_DIR}/artifacts/wrdata/track_hold_sim1_bsim4_elided_300_perf_out.txt}"
...
PERF_LOG="${PERF_LOG:-${SCRIPT_DIR}/artifacts/perf/run_track_hold_sim1_bsim4_elided_300_perf_${RUN_ID}.csv}"
STRACE_LOG="${STRACE_LOG:-${SCRIPT_DIR}/artifacts/strace/run_track_hold_sim1_bsim4_elided_300_strace_${RUN_ID}.log}"
