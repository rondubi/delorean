...
SCRIPTS: Dict[str, str] = {
    "sim1_bsim4": f"{RUN_SCRIPTS_DIR}/run_track_hold_sim1_bsim4.sh",
    "sim1_bsim4_elided": f"{RUN_SCRIPTS_DIR}/run_track_hold_sim1_bsim4_elided.sh",
    "sim2_bsim4": f"{RUN_SCRIPTS_DIR}/run_track_hold_sim2_bsim4.sh",
    "sim2_bsim4_elided": f"{RUN_SCRIPTS_DIR}/run_track_hold_sim2_bsim4_elided.sh",
}
